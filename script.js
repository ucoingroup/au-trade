...
const COMMODITIES = [
    {
        ...
        tag:"AU→CN",
        hsCode:"2601",
        ausTradeValue:"~USD 102B (2024, AU→CN)",
        cnImportVol:"1,182万万吨 (2024全年)",
        ...
        yoyChange:"-8.1% (price decline 2024 vs 2023)",
        trend:"stable",
        keyEvents:{en:"Iron ore price dropped from $130/t (2023 peak) to $95-105/t (2024-2025). China steel demand declining with property slowdown. Australia shipped record volume via Port Hedland (546Mt H1 2025).",zh:"铁矿石价格从$130/吨（2023高点）降至$95-105/吨（2024-2025）。中国钢铁需求随地产放缓下降。澳洲黑德兰港创纪录出口5.46亿吨（2025上半年）。"},
    ...
    },
    {
        ...
        yoyChange:"+46% CN imports from AU (2024 vs 2023, recovery from 2020 ban)",
        trend:"up",
        keyEvents:{en:"China lifted AU coal import restrictions in 2023. 2024 imports hit 80Mt+ from AU. Newcastle benchmark price ~$128/t. Global shift: India emerging as top thermal coal importer.",zh:"中国2023年取消澳煤进口限制。2024年自澳进口超8000万吨。纽卡斯尔基准价约$128/吨。全球转变：印度成为最大动力煤进口国。"},
    ...
    },
    {
        ...
        yoyChange:"+4.5% price (2025, geopolitical premium from Middle East tensions)",
        trend:"up",
        keyEvents:{en:"Australia #2 global LNG exporter (after Qatar). Iran conflict disrupted Qatar supply in 2026 → AU LNG windfall. Long-term contracts: CNOOC, PetroChina with AU suppliers (Woodside, Santos).",zh:"澳大利亚全球第二大LNG出口国（仅次于卡塔尔）。2026年伊朗冲突干扰卡塔尔供应→澳LNG意外收益。长约：中海油、中石油与澳供应商（Woodside、Santos）。"},
        cities:["shanghai","guangdong","chongqing"],
        cityRelevance:{
    ...
    },
    {
        ...
        yoyChange:"+3.2% (AU beef to CN 2024, recovering)",
        trend:"up",
        keyEvents:{en:"China launched 3-year beef safeguard measures (2026): total quota 2.7Mt, AU share 200Kt. AU lobster ban lifted (2024). AU beef on track for record exports in 2024-25 fiscal year.",zh:"中国启动3年牛肉保障措施（2026）：总配额270万吨，澳份额20万吨。澳龙虾禁令解除（2024）。澳牛肉2024-25财年有望创纪录。"},
    ...
    },
    {
        ...
        cnImportVol:"China: 5.8M vehicle exports (2024), #1 globally; EVs 2M+ units",
        ...
        yoyChange:"+25% (CN vehicle exports 2024); BYD in Australia +120% (2024)",
        trend:"up",
        keyEvents:{en:"BYD overtook Honda globally. China #1 vehicle exporter. Thailand: BYD factory in Rayong. Australia: MG3 = cheapest car; BYD Atto3 = top EV. EU tariffs on CN EVs → redirect to ASEAN/AU.",zh:"比亚迪全球超越本田。中国第一大汽车出口国。泰国：比亚迪罗勇工厂。澳洲：MG3=最便宜车；BYD Atto3=最畅销EV。欧盟对华EV加税→转向东盟/澳。"},
        cities:["guangdong","chongqing","shanghai"],
        cityRelevance:{
    ...
    },
    {
        ...
        yoyChange:"-2% (2024 crude prices declining)",
        trend:"stable",
        keyEvents:{en:"ASEAN crude flows shifting: less to CN, more to India. Singapore = Asia's refining hub. AU refining capacity declining, importing more refined product.",zh:"东盟原油流向转变：减少对中国，增加对印度。新加坡=亚洲炼油中心。澳炼能下降，进口更多成品油。"},
    ...
    },
    {
        ...
        yoyChange:"+25% (gold price 2024, safe-haven demand); AU→CN volume +5%",
        trend:"up",
        keyEvents:{en:"Gold overtook LNG to become AU's #2 resource export (FY2025-26). Price hit $2,700+/oz (2025). Central bank buying surging. AU gold export revenue surging to AUD 60B. Perth Mint = LBMA certified. AU gold production stable at ~320t/year. Geopolitical risk driving safe-haven demand.",zh:"黄金超越LNG成为澳洲第二大资源出口（2025-26财年）。价格突破$2,700/盎司（2025）。央行购金激增。澳黄金出口收入飙升至600亿澳元。珀斯铸币厂=LBMA认证。澳黄金产量稳定约320吨/年。地缘风险驱动避险需求。"},
        cities:["shanghai"],
        cityRelevance:{
    ...
    },
    {
        ...
        yoyChange:"-30% (lithium carbonate price crashed from $80K to $10K/t in 2024)",
        trend:"stable",
        keyEvents:{en:"Lithium price crashed 80% from 2022 peak. AU mines cutting production. CN overcapacity in refining. CATL/Tianqi/Ganfeng dominating mid-stream. EU Critical Raw Materials Act pushing diversification away from CN refining.",zh:"锂价从2022高点暴跌80%。澳矿减产。中国提炼产能过剩。宁德时代/天齐/赣锋主导中游。欧盟关键原材料法推动摆脱中国提炼依赖。"},
        cities:["guangdong","shanghai"],
        cityRelevance:{
...
// ---- Price Data ----
const PRICES = [
    { icon:"⛏️", en:"Iron Ore (62% Fe)", zh:"铁矿石（62%品位）", price:"$98.5", change:"+2.3%", unit:"USD/dry ton (DCE)", up:true },
    { icon:"🔥", en:"Thermal Coal (Newcastle)", zh:"动力煤（纽卡斯尔）", price:"$128.0", change:"-1.1%", unit:"USD/ton FOB", up:false },
    { icon:"🛢️", en:"LNG (JKM)", zh:"液化天然气（JKM）", price:"$12.8", change:"+4.5%", unit:"USD/MMBtu", up:true },
    { icon:"🥩", en:"Beef (FOB Aus)", zh:"牛肉（澳FOB）", price:"$7.20", change:"+1.8%", unit:"USD/kg", up:true },
    ...
    { icon:"🪙", en:"Gold (XAU)", zh:"黄金", price:"$2,685", change:"+1.2%", unit:"USD/oz (LBMA)", up:true },
...
const POLICIES = [
    {
        ...
        details: [
            ...
            {en:"Beef: Within-quota 0%; 2026 safeguard quota: AU share 200Kt",zh:"牛肉：配额内0%；2026保障配额：澳份额20万吨"},
